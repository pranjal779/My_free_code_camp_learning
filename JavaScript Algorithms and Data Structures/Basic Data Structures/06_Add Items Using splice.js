...
// Tests
// Passed:1. htmlColorNames should return ["DarkSalmon", "BlanchedAlmond", "LavenderBlush", "PaleTurquoise", "FireBrick"]
// Passed:2. The htmlColorNames function should utilize the splice() method
// Passed:3. You should not use shift() or unshift().
// Passed:4. You should not use array bracket notation.
