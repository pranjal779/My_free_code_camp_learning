...
//  the a characters are not in a row - there is a b between them. Finally, since there is no a in the string bcd, it wouldn't find a match.
...
// Tests
// Passed:1. Your regex myRegex should use the + sign to match one or more s characters.
// Passed:2. Your regex myRegex should match 2 items.
// Passed:3. The result variable should be an array with two matches of ss
