...
// Tests
// Passed:1. You should search for caboose with the dollar sign $ anchor in your regex.
// Passed:2. Your regex should not use any flags.
// Passed:3. You should match caboose at the end of the string The last car on a train is the caboose
