...
// Tests
// Passed:1. Your code should fix the condition so it checks for equality, instead of using assignment.
// Passed:2. The condition should use either == or === to test for equality.
