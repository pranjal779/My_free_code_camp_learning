...
//  while the browser console will output all messages. When you make changes to your code, it will automatically run and show the logs. The freeCodeCamp console is then cleared each time your code runs.
...
// Tests
// Passed:1. You should use console.log() to print the output variable.
// Passed:2. You should use console.clear() to clear the browser console.
// Passed:3. You should clear the console after your log.
